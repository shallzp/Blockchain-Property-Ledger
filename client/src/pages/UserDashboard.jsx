...
import { User, Home, Search, Bed, Bath, FileText, Send, Eye, ChevronRight, Calendar } from 'lucide-react';
...
const UserDashboard = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      if (isConnected && currentAccount) {
        try {
          ...
          // Placeholder for total properties available on market
          // Replace with actual contract call where feasible
          setTotalAvailable(156);
    ...
    fetchUserData();
  }, [isConnected, currentAccount, getPropertiesOfOwner, getMySales, getRequestedSales]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
      ...
      <div className="relative px-8 py-12 max-w-6xl mx-auto">
          ...
          {['All', 'Villa', 'Apartment', 'House', 'Land'].map(type => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition ${
                propertyType === type ? 'bg-orange-500 text-white' : 'bg-white/90 text-gray-700 hover:bg-white'
              }`}
            >
        ...
        {/* Left Search Card */}
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 w-110 opacity-90 shadow-xl mb-12 mx-auto">
        ...
        {/* Right Property Card - first property or placeholder */}
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 w-80 shadow-xl opacity-90 mx-auto">
            ...
            <>
              ...
              <div className="flex gap-4 mb-4">
                <div className="flex items-center gap-2">
                  <span className="w-4 h-4" /> {/* Removed unused icon Maximize */}
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-4 gap-6 mt-8 max-w-6xl mx-auto">
          {/* Your Properties */}
          <button
            onClick={() => navigate('/properties')}
